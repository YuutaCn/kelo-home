...
$(function () {
  jQuery(document).ready(function (e) {
    jQuery(document).on("click", ".mob-menu", function () {
      ...
      t.preventDefault(), jQuery(".form .buttons button").removeClass("active"), jQuery(this).addClass("active"), e('[name="button"]').val(jQuery(this).children("span").text()), "E-mail" == e(this).children("span").text() ? (e(this).parents("form").find("[name='phone']").prop("hidden", !0), e(this).parents("form").find("[name='mail']").prop("hidden", !1)) : "WhatsApp" == e(this).children("span").text() ? (e(this).parents("form").find("[name='phone']").prop("hidden", !1), e(this).parents("form").find("[name='phone']").attr("placeholder", "Введите номер WhatsApp"), e(this).parents("form").find("[name='mail']").prop("hidden", !0)) : "Telegram" == e(this).children("span").text() ? (e(this).parents("form").find("[name='phone']").prop("hidden", !1), e(this).parents("form").find("[name='phone']").attr("placeholder", "Введите свой Telegram"), e(this).parents("form").find("[name='mail']").prop("hidden", !0)) : (e(this).parents("form").find("[name='phone']").prop("hidden", !1), e(this).parents("form").find("[name='phone']").attr("placeholder", "Введите свой телефон"), e(this).parents("form").find("[name='mail']").prop("hidden", !0));
      ...
      e(".item-1 .otvet .item").removeClass("active"), e(this).addClass("active"), e("[name='otvet1']").attr("value", e(this).find(".desk").text()), console.log(e(this).find(".desk").text()), e(".vopros .otvet .item").removeClass("error");
    ...
    }), e(window).width(), e(".send-form").submit(function (t) {
      t.preventDefault();
      var o = e(this);
      console.log(o), e.ajax({
        ...
        success: function success(t) {
          console.log(t), o.trigger("reset"), e(".modal").modal("hide"), e("#senk").modal("show"), setTimeout(function () {
            e("#senk").modal("hide");
          }, 3e3);
        },
    ...
    }), e('[name="phone"]').mask("+7 (999) 999-99-99"), e('a[href^="#"].yak').click(function () {
